...
def build_scene_spec(script):
    ...
    return {
        ...
        "landmark_keys": sorted(({"frame": k["frame"], "points": k["points"], "score": k.get("score"), "tones": k.get("tones"), "hair_tones": k.get("hair_tones")} for k in script["characters"]["face_landmarks"]["keyframes"]),
